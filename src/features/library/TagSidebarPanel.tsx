...
export default function TagSidebarPanel({
  ...
  return (
    <div
      ...
      className={cn(
        `order-2 h-svh w-full flex-shrink-0 flex flex-col border-t bg-background text-foreground overflow-hidden ${MOBILE_DRAWER_TRANSITION_CLASSES} md:page-enter md:order-none md:h-auto md:min-h-0 md:w-72 md:translate-x-0 md:border-t-0 md:border-r`,
