...
interface MetadataLinkDescriptor {
  id: MetadataLinkId;
  label: string;
  relation: string;
...
const descriptorById = {
  artist: {
    ...
    disabledReason: "artist is controlled by the album; unlink it in settings to edit per track",
  ...
  year: {
    ...
    disabledReason: "year is controlled by the album; unlink it in settings to edit per track",
  ...
  genre: {
    ...
    disabledReason: "genre is controlled by the album; unlink it in settings to edit per track",
  ...
  artwork: {
    ...
    disabledReason: "artwork is controlled by the album; unlink it in settings to edit per track",
  ...
  trackNumber: {
    ...
    disabledReason: "track number follows album order; unlink it in settings to edit per track",
  ...
  albumArtist: {
    ...
    disabledReason: "album artist follows track artist; unlink it in settings to edit separately",
