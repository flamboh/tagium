      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm leading-6 text-muted-foreground">
            ...
            accessible audio — the same content anyone can already save with the dev tools in any
            modern browser. it cannot be used to bypass paywalls or access private content.
          </p>
          <p className="text-sm leading-6 text-muted-foreground">
