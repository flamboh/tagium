...
import { parseUploads, runAudioBackendEffect, writeTags } from "./audioBackend";
import {
...
import { getSystemFailurePresentation } from "./systemFailure";
...
export interface TrackEditorSession {
  ...
  commands: {
    ...
    hydrateDownloadedTrack: (
      fileId: string,
      downloadedFile: File,
    ) => Effect.Effect<void, Error, import("./audioBackend").AudioBackend>;
  };
}
