...
vi.mock("@/src/analytics", () => ({ analytics: { capture: exportMocks.capture } }));
vi.mock("./systemFailure", () => ({ reportSystemFailure: exportMocks.reportFailure }));
vi.mock("./downloadLibrary", () => ({
...
import { createLibraryState, libraryReducer } from "./libraryState";
